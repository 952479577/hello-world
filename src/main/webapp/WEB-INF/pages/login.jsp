					...
					<div class="infos">
						<table class="field">
							...
							<tr>
								...
								<td>
									 <input type="text" name="username"  id="User_login_action_username" class="text" required="true" value="a"/>
								</td>
							</tr>
							<tr>
								<td class="field">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
								<td>
									<input type="password" name="password" id="User_login_action_password" class="text" required="true"  value="a"/>
								</td>
							</tr>
						<!-- <tr>
