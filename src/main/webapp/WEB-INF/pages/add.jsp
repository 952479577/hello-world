					...
					<div class="infos">
						<table class="field">
							<tr>
								...
								<td>
									<input type="text" name="title" value="" id="House_add_action_title" class="text" value="好房子"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<input type="text" name="floorage" value="" id="House_add_action_floorage" class="text" value="100"/>
								</td>
							</tr>
							<tr>
								<td class="field">价 格：</td>
								<td><input type="text" name="price" value="" id="House_add_action_price" class="text" value="4000"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" name="contact" value="" id="House_add_action_contact" class="text" value="17745644564"/></td>
							</tr>
							<tr>
