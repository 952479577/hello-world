...
public class BaseDaoMybatisImpl<T> extends SqlSessionDaoSupport implements BaseDao<T> {
	...
	//重写了父类SqlSessionDaoSupport 方法实现注入sqlSessionTemplate
	...
	public List<T> findAll(T t, String sqlId) {
		return super.getSqlSession().selectList(MAPPERPATH+t.getClass().getSimpleName()+"Mapper."+sqlId);
	}
	@Override
	...
	public int getCount(Class<T> clazz, Map<String, Object> map, String sqlID) {
		return super.getSqlSession().selectOne(MAPPERPATH+clazz.getSimpleName()+"Mapper."+sqlID,map);
	}
	...
	public double getFunc(Class<T> clazz, String sqlId,Map<String, Object> map) {
		return new Double (super.getSqlSession().selectOne(MAPPERPATH+clazz.getSimpleName()+"Mapper."+sqlId,map).toString());
	}
